<?php require_once __DIR__ . '/controller/ranks.php'; ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8"/>
        ...
        <link href="css/pages/ranks.css" rel="stylesheet"/>
    </head>
    <body class="page-ranks">
        <div id="wrap">
            ...
            <main class="main-content" id="main">
                <div class="container">
                    ...
                    <section aria-labelledby="page-title" class="prose">
                        ...
                        <p>
                            VIP ranks are temporarily unavailable while we complete a secure store update.
                        </p>
                        <p>
