...
$adminContentTemplate = match ($adminSection) {
    'categories' => 'admin/catalog/categories/index.php',
    'products' => 'admin/catalog/products/index.php',
    'recommended' => 'admin/home/recommended.php',
    'coupons' => 'admin/commerce/coupons/index.php',
    'orders' => 'admin/commerce/orders/index.php',
    'maintenance' => 'admin/maintenance/index.php',
    default => 'admin/dashboard/overview.php',
};
