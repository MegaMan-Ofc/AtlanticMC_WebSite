...
$adminTemplate = file_get_contents($root . '/templates/admin/home/category-layout.php');
$adminJavaScript = file_get_contents($root . '/public_html/js/admin.js');
$adminController = file_get_contents($root . '/controllers/Admin/admin.php');
...
$assert(
    is_file($root . '/database/migrations/mysql/008_home_category_layout.php')
        ...
        && is_file($root . '/app/Admin/Home/customization.php')
