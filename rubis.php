<?php require_once __DIR__ . '/controller/rubis.php'; ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8"/>
            ...
            <main class="main-content" id="main">
                <div class="container">
                    ...
                    <section aria-labelledby="page-title" class="prose">
                        ...
                        <p>
                            Rubis packages are temporarily unavailable while we complete a secure store update.
                        </p>
                        <p>
