...
function seed_store_database(PDO $pdo): void
{
    ...
    $insertProduct = $pdo->prepare(
        'INSERT INTO products (slug, category, category_id, name, description, image, price_cents, currency, active, sort_order, tebex_package_id, metadata, created_at, updated_at)
         VALUES (:slug, :category, :category_id, :name, :description, :image, :price_cents, :currency, 1, :sort_order, :tebex_package_id, :metadata, :created_at, :updated_at)'
    );
