    ...
    <main class="main-content" id="main">
        <div class="container">
            ...
            <section aria-label="<?= e(t('home.categories_aria')) ?>" class="category-grid">
                <a class="category-card" data-theme="vips" href="<?= e(url('ranks.php')) ?>"><img alt="<?= e(t('home.diamond_alt')) ?>" src="<?= e(url('assets/diamante.png')) ?>"><h2>VIPs</h2></a>
                <a class="category-card" data-theme="rubis" href="<?= e(url('rubis.php')) ?>"><img alt="<?= e(t('home.rubis_alt')) ?>" src="<?= e(url('assets/rubis-saco-pequeno.png.png')) ?>"><h2>Rubis</h2></a>
                <a class="category-card" data-theme="keys" href="<?= e(url('keys.php')) ?>"><img alt="<?= e(t('home.key_alt')) ?>" src="<?= e(url('assets/atlantic-key.png')) ?>"><h2><?= e(t('category.keys')) ?></h2></a>
                <a class="category-card" data-theme="money" href="<?= e(url('battlepass.php')) ?>"><i aria-hidden="true" class="fa-solid fa-ticket"></i><h2><?= e(t('category.battlepass')) ?></h2><small><?= e(t('home.season_rewards')) ?></small></a>
            </section>
